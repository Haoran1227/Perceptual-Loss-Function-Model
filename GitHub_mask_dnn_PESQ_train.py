#####################################################################################
# GitHub_mask_dnn_PESQ_train -
# Training the PMESQ-loss mask-based DNN model for speech enhancement, i.e., PMESQ loss as loss
# Given data:
#       Training input
...
#       Validation target
# Output data:
#       Trained DNN model (with PESQ loss)
#
...
# 2. define model
#####################################################################################
# Define the PMESQ loss. see reference [1].
...
best_weights = "./training results/mask_dnn_PESQ_" + SNR_situ + "_weights.h5"
...
ValiLossVec='./training results/mask_dnn_PESQ_' + 'validationloss.mat'
