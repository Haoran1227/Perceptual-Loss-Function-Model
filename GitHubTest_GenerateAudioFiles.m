...
noi_lev = -46; % Change "noi_lev" for various SNRs
save_files_flag = 1; % 1- Save all generated files; 0- Not save 
modle_type_str_vec = {'baseline','weight_filter_AMR_direct_freqz'}; % run both models to compare
noi_situ_model_str = '6snrs'; 
Fs = 16000;
speech_length = 95*Fs;
file_sec = 95; % Generated files have 95 seconds duration
...
for k_model_type = 1 : length(modle_type_str_vec)
    ...
    for k = 1 : file_num
        ...
        if save_files_flag == 1
            save(['./generated_files/' num2str(noi_lev) '/s_hat_test_data_snr_' num2str(noi_lev) '_model_' noi_situ_model_str '_' modle_type_str '_' num2str(k) '.mat'],'s_hat_temp');
            %save(['./generated_files/' num2str(noi_lev) '/s_tilde_test_data_snr_' num2str(noi_lev) '_model_' noi_situ_model_str '_' modle_type_str '_' num2str(k) '.mat'],'s_tilt_temp');
            %save(['./generated_files/' num2str(noi_lev) '/n_tilde_test_data_snr_' num2str(noi_lev) '_model_' noi_situ_model_str '_' modle_type_str '_' num2str(k) '.mat'],'n_tilt_temp');
            save(['./generated_files/' num2str(noi_lev) '/y_test_data_snr_' num2str(noi_lev) '_' num2str(k) '.mat'],'y_vec_temp');
            save(['./generated_files/' num2str(noi_lev) '/s_' num2str(k) '.mat'],'s_vec_temp');
            save(['./generated_files/' num2str(noi_lev) '/n_test_data_snr_' num2str(noi_lev) '_' num2str(k) '.mat'],'n_vec_temp');
            audiowrite(['./generated_files/' num2str(noi_lev) '/clean_speech.wav'],s_vec_temp./2^15,Fs);
            audiowrite(['./generated_files/' num2str(noi_lev) '/s_hat_test_data_snr_' num2str(noi_lev) '_model_' noi_situ_model_str '_' modle_type_str '_' num2str(k) '.wav'],s_hat_temp./2^15,Fs);
            audiowrite(['./generated_files/' num2str(noi_lev) '/y_test_data_snr_' num2str(noi_lev) '_' num2str(k) '.wav'],y_vec_temp./2^15,Fs);
        end
